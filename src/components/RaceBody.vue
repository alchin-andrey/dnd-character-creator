...
const Char_Img = computed(() => {
  ...
  // const image_path = `/dnd-character-creator/src/assets/img/characters/${race}${ethnos}/${sex}/${body}/${img}.png`;
  // const image_path = `img/characters/${race}${ethnos}/${sex}/${body}/${img}.png`;
  ...
  let result;
  try {
    // result = new URL("../assets/img/characters/" + image_path + ".png", import.meta.url).href;
    // result = new URL("../assets/" + image_path, import.meta.url).href;
    result = new URL(image_path, import.meta.url).href;
